...
Coded by a dumbass kid- github.com/VasuDevbyte
...
def banner():
    ...
    print(f'{lg}   Version: {w}1.0{lg} | Author: {w}VasuDevbyte{rs}\n')
...
for a in accounts:
    ...
    clnt = TelegramClient(f'sessions/{phn}', 6871874, '4669477e3e3e51742054a03d638ca6d9')
    clnt.connect()
    banned = []
